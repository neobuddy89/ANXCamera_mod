...
class zzhi<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* synthetic */ zzhi(int i, zzhh zzhh) {
        this(i);
    }
    ...
    static <FieldDescriptorType extends zzey<FieldDescriptorType>> zzhi<FieldDescriptorType, Object> zza(int i) {
        return new zzhh(i);
    }
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            this.zzb.add(new zzhn(this, (Map.Entry) it.next()));
            it.remove();
        }
        return value;
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzhp(this, (zzhh) null);
        }
        return this.zze;
    }
    ...
    public boolean equals(Object obj) {
        ...
        int zzc2 = zzc();
        if (zzc2 != zzhi.zzc()) {
            return entrySet().equals(zzhi.entrySet());
        }
        for (int i = 0; i < zzc2; i++) {
            if (!zzb(i).equals(zzhi.zzb(i))) {
                return false;
            }
        }
        if (zzc2 != size) {
            return this.zzc.equals(zzhi.zzc);
        }
        return true;
    }
    ...
    public final Set<Map.Entry<K, V>> zze() {
        if (this.zzg == null) {
            this.zzg = new zzhj(this, (zzhh) null);
        }
        return this.zzg;
    }
}
