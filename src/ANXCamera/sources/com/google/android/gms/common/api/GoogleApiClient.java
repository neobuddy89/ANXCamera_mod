...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public final ClientSettings buildClientSettings() {
            ClientSettings clientSettings = new ClientSettings(this.zax, this.zabr, this.zabx, this.zabt, this.zabu, this.zabv, this.zabw, this.zabz.containsKey(zaa.API) ? (SignInOptions) this.zabz.get(zaa.API) : SignInOptions.DEFAULT, false);
