...
public class BaseFragmentDelegate implements ModeProtocol.BaseDelegate {
    public static final int BEAUTY_FRAGMENT_CONTAINER_ID = 2131296287;
    ...
    private void applyUpdateSet(List<BaseFragmentOperation> list, BaseLifecycleListener baseLifecycleListener) {
        ...
        if (camera == null || !camera.isFinishing()) {
            ...
            for (BaseFragmentOperation next : list) {
                int activeFragment = getActiveFragment(next.containerViewId);
                int i = next.pendingFragmentInfo;
                switch (next.operateType) {
                    case 1:
                        int activeFragment2 = getActiveFragment(next.containerViewId);
                        ...
                        beginTransaction.replace(next.containerViewId, constructFragment, constructFragment.getFragmentTag());
                        this.animationComposite.put(constructFragment.getFragmentInto(), constructFragment);
                        updateCurrentFragments(next.containerViewId, i, next.operateType);
                        break;
                    case 2:
                    ...
                    case 3:
                        ...
                        updateCurrentFragments(next.containerViewId, activeFragment, next.operateType);
                        break;
                    case 4:
                        ...
                        if (baseFragment4 != null) {
                            ...
                            beginTransaction.add(next.containerViewId, baseFragment4, baseFragment4.getFragmentTag());
                        }
                        this.animationComposite.put(baseFragment4.getFragmentInto(), baseFragment4);
                        updateCurrentFragments(next.containerViewId, i, next.operateType);
                        break;
                    case 5:
                        List list2 = this.currentFragments.get(next.containerViewId);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0038, code lost:
        if (((java.lang.Integer) r0.get(r1)).intValue() != r4) goto L_0x003e;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0060, code lost:
        if (r1 >= r0.size()) goto L_0x00a5;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x006c, code lost:
        if (((java.lang.Integer) r0.get(r1)).intValue() != r4) goto L_0x0072;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0085, code lost:
        if (((java.lang.Integer) r0.get(r1)).intValue() != r4) goto L_0x008b;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x001e, code lost:
        if (((java.lang.Integer) r0.get(r1)).intValue() != r4) goto L_0x0025;
     */
    ...
    private void updateCurrentFragments(@IdRes int i, int i2, int i3) {
        List list = this.currentFragments.get(i);
        int i4 = 0;
        switch (i3) {
            case 1:
                if (list == null) {
    ...
    public void delegateEvent(int i) {
        ...
        switch (i) {
            ...
            case 6:
                if (getActiveFragment(R.id.bottom_action) == 4083) {
                    ...
                    if (b.isSupportedOpticalZoom() || b.fl() || HybridZoomingSystem.IS_3_OR_MORE_SAT) {
        ...
        if (!arrayList.isEmpty()) {
            applyUpdateSet(arrayList, (BaseLifecycleListener) null);
        }
    }
    ...
    public Disposable delegateMode(@Nullable Completable completable, StartControl startControl, final BaseLifecycleListener baseLifecycleListener) {
        ...
        if (completable != null) {
            if (baseLifecycleListener != null) {
                completable.subscribe((Action) r0);
            } else {
                completable.subscribe();
            }
        }
        return this.animationComposite.dispose((Completable) null, (Action) null, startControl);
    }
    ...
    public void init(FragmentManager fragmentManager, int i, BaseLifecycleListener baseLifecycleListener) {
        ...
        BaseFragment constructFragment8 = constructFragment(true, FRAGMENT_SUBTITLE, 240, baseLifecycleListener2);
        ...
        if (DataRepository.dataItemFeature().Nc()) {
            BaseFragment constructFragment9 = constructFragment(true, FRAGMENT_ID_CARD, 240, baseLifecycleListener2);
            beginTransaction.replace(R.id.id_card_content, constructFragment9, constructFragment9.getFragmentTag());
            this.animationComposite.put(constructFragment9.getFragmentInto(), constructFragment9);
            this.originalFragments.put(R.id.id_card_content, constructFragment9.getFragmentInto());
        }
        BaseFragment baseFragment = null;
        if (b.isSupportedOpticalZoom() || HybridZoomingSystem.IS_3_OR_MORE_SAT) {
            baseFragment = constructFragment(true, 4084, 240, baseLifecycleListener2);
        } else if (b.fl()) {
            baseFragment = constructFragment(true, 4085, 240, baseLifecycleListener2);
        }
        if (baseFragment != null) {
        ...
        if (DataRepository.dataItemFeature().sd()) {
            BaseFragment constructFragment11 = constructFragment(true, 4094, 240, baseLifecycleListener2);
    ...
    public void loadFeatureFragment(List<BaseFragmentOperation> list) {
        FragmentTransaction beginTransaction = this.mSupportFragmentManager.beginTransaction();
        for (BaseFragmentOperation next : list) {
            int i = next.containerViewId;
            if (getActiveFragment(i) == 240) {
                BaseFragment baseFragment = (BaseFragment) Fragment.instantiate(this.mActivity, next.pendingFragmentAlias);
