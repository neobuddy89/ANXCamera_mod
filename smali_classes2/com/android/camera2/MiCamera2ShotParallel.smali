...
.method configParallelSession(Landroid/util/Size;)V
    ...
    invoke-static {v5}, Lcom/xiaomi/camera/base/CameraDeviceUtil;->getCameraCombinationMode(I)I

    move-result v5

    invoke-direct {v3, v4, v0, v2, v5}, Lcom/xiaomi/engine/GraphDescriptorBean;-><init>(IIZI)V
    ...
    invoke-direct {v3, v0, v2, v2, v4}, Lcom/xiaomi/engine/GraphDescriptorBean;-><init>(IIZI)V
    ...
    invoke-direct {v1, v0, v2, v4, v3}, Lcom/xiaomi/engine/BufferFormat;-><init>(IIILcom/xiaomi/engine/GraphDescriptorBean;)V
...
.method configParallelSession(Landroid/util/Size;I)V
    ...
    invoke-direct {v1, p2, v0, v2, v3}, Lcom/xiaomi/engine/BufferFormat;-><init>(IIILcom/xiaomi/engine/GraphDescriptorBean;)V
    ...
    invoke-virtual {p2, v1}, Lcom/android/camera/LocalParallelService$LocalBinder;->configCaptureSession(Lcom/xiaomi/engine/BufferFormat;)V

    new-instance p2, Lcom/android/camera/CameraSize;

    invoke-direct {p2, p1}, Lcom/android/camera/CameraSize;-><init>(Landroid/util/Size;)V

    iput-object p2, p0, Lcom/android/camera2/MiCamera2ShotParallel;->mCapturedImageSize:Lcom/android/camera/CameraSize;
