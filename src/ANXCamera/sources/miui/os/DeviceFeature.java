...
public class DeviceFeature {
    ...
    public static final boolean SUPPORT_CAMERA_ANIMATION = ("pyxis".equals(aeonax.Build.ANXDEVICE) || "vela".equals(aeonax.Build.ANXDEVICE));
    ...
    public static final boolean SUPPORT_LAB_GESTURE = ("sagit".equals(aeonax.Build.ANXDEVICE) && !Build.IS_STABLE_VERSION);
    ...
    static {
        ...
        if ("cepheus".equals(aeonax.Build.ANXDEVICE) && !Build.IS_INTERNATIONAL_BUILD) {
            z = true;
        }
    ...
    public static final boolean hasFlipSupport() {
        return "draco".equals(aeonax.Build.ANXDEVICE);
    }

    public static final boolean hasMirihiSupport() {
        return "perseus".equals(aeonax.Build.ANXDEVICE) || "andromeda".equals(aeonax.Build.ANXDEVICE);
    }

    public static final boolean hasPopupCameraSupport() {
        return "raphael".equals(aeonax.Build.ANXDEVICE) || "davinci".equals(aeonax.Build.ANXDEVICE) || "raphaelin".equals(aeonax.Build.ANXDEVICE) || "davinciin".equals(aeonax.Build.ANXDEVICE);
    }
