...
public class C0162e {
    ...
    public C0162e(Context context, String str, String str2, String str3, boolean z) {
        this.i = 0;
        this.j = 0;
        this.k = 0;
        this.f547a = false;
    ...
    public C0162e(Context context, String str, String str2, boolean z) {
        this(context, str, str2, z, (String) null);
    }

    public C0162e(Context context, String str, String str2, boolean z, String str3) {
        this.i = 0;
        this.j = 0;
        this.k = 0;
        this.f547a = true;
    ...
    private void a(Context context, String str, String str2, boolean z, String str3) {
        ...
        r.a();
        this.f551e.execute(new C0163f(this, str3, z));
    }
    ...
    public void f() {
        if (this.f547a) {
            ...
            if (p == -1) {
                ...
                this.f551e.execute(new C0167j(this, a2, p));
            }
        }
    }
    ...
    /* access modifiers changed from: private */
    public boolean g() {
        return !C0159b.d(this.f549c) || C0159b.e(this.f549c) != 2;
    }

    /* access modifiers changed from: private */
    public boolean g(boolean z) {
        if (C0159b.d(this.f549c)) {
            return C0159b.e(this.f549c) != 2;
        }
        if (!C0159b.e() || z) {
    ...
    static /* synthetic */ int m(C0162e eVar) {
        int i2 = eVar.i;
        eVar.i = i2 - 1;
        return i2;
    }
    ...
    public void d(boolean z) {
        this.f551e.execute(new C0166i(this, z));
    }

    public void e(String str) {
        if (this.f547a) {
            this.f551e.execute(new C0165h(this, str));
        }
    }
