...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public Action build() {
                ...
                Action action = new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, arrayList2.isEmpty() ? null : arrayList2.toArray(new RemoteInput[arrayList2.size()]), arrayList.isEmpty() ? null : (RemoteInput[]) arrayList.toArray(new RemoteInput[arrayList.size()]), this.mAllowGeneratedReplies, this.mSemanticAction, this.mShowsUserInterface);
                return action;
            }
        ...
        public static class UnreadConversation {
            ...
            public static class Builder {
                ...
                public UnreadConversation build() {
                    ...
                    UnreadConversation unreadConversation = new UnreadConversation((String[]) list.toArray(new String[list.size()]), this.mRemoteInput, this.mReplyPendingIntent, this.mReadPendingIntent, strArr, this.mLatestTimestamp);
    ...
    public static class MessagingStyle extends Style {
        ...
        private TextAppearanceSpan makeFontColorSpan(int i) {
            TextAppearanceSpan textAppearanceSpan = new TextAppearanceSpan((String) null, 0, 0, ColorStateList.valueOf(i), (ColorStateList) null);
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                for (Message next : this.mMessages) {
                    if (Build.VERSION.SDK_INT >= 28) {
                        ...
                        message = new Notification.MessagingStyle.Message(next.getText(), next.getTimestamp(), person == null ? null : person.toAndroidPerson());
                    } else {
                        CharSequence charSequence = null;
                        if (next.getPerson() != null) {
                            charSequence = next.getPerson().getName();
                        }
                        message = new Notification.MessagingStyle.Message(next.getText(), next.getTimestamp(), charSequence);
                    }
    ...
    public static abstract class Style {
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            Bitmap createColoredBitmap = createColoredBitmap(R.drawable.notification_icon_background, i4 == 0 ? 0 : i4, i2);
