    ...
    private boolean updatePreviewSecondRender() {
        ...
        synchronized (this.mRenderChangedLock) {
            ...
            if (this.mIsStickerEnabled) {
                ...
                Render fetchRender4 = this.mIsKaleidoscopeEnabled ? fetchRender(FilterInfo.FILTER_ID_KALEIDOSCOPE) : null;
                Render fetchRender5 = this.mEffectId != FilterInfo.FILTER_ID_NONE ? fetchRender(this.mEffectId) : null;
                ...
                if (this.mIsZebraEnabled) {
                    render = fetchRender(FilterInfo.FILTER_ID_ZEBRA);
                }
                ...
                if (fetchRender4 != null) {
                    ...
                    fetchRender4.setKaleidoscope(EffectController.getInstance().getCurrentKaleidoscope());
                }
