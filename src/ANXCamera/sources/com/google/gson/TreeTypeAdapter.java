...
final class TreeTypeAdapter<T> extends TypeAdapter<T> {
    ...
    public static TypeAdapterFactory newFactory(TypeToken<?> typeToken2, Object obj) {
        SingleTypeFactory singleTypeFactory = new SingleTypeFactory(obj, typeToken2, false, (Class) null);
        return singleTypeFactory;
    }

    public static TypeAdapterFactory newFactoryWithMatchRawType(TypeToken<?> typeToken2, Object obj) {
        SingleTypeFactory singleTypeFactory = new SingleTypeFactory(obj, typeToken2, typeToken2.getType() == typeToken2.getRawType(), (Class) null);
        return singleTypeFactory;
    }

    public static TypeAdapterFactory newTypeHierarchyFactory(Class<?> cls, Object obj) {
        SingleTypeFactory singleTypeFactory = new SingleTypeFactory(obj, (TypeToken) null, false, cls);
        return singleTypeFactory;
    }
