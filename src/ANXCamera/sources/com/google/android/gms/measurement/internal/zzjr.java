...
public final class zzjr implements ServiceConnection, BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener {
    ...
    public final void onConnected(Bundle bundle) {
        ...
        synchronized (this) {
            try {
                this.zza.zzq().zza((Runnable) new zzjw(this, (zzfb) this.zzc.getService()));
    ...
    public final void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        this.zza.zzq().zza((Runnable) new zzjy(this));
    }

    public final void onConnectionSuspended(int i) {
        Preconditions.checkMainThread("MeasurementServiceConnection.onConnectionSuspended");
        this.zza.zzr().zzw().zza("Service connection suspended");
        this.zza.zzq().zza((Runnable) new zzjv(this));
    }
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        synchronized (this) {
            ...
            try {
                ...
                if ("com.google.android.gms.measurement.internal.IMeasurementService".equals(interfaceDescriptor)) {
                    if (iBinder != null) {
                        ...
                        zzfd = queryLocalInterface instanceof zzfb ? (zzfb) queryLocalInterface : new zzfd(iBinder);
                    }
            ...
            if (zzfd == null) {
                ...
                this.zza.zzq().zza((Runnable) new zzju(this, zzfd));
            }
        }
    }
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        ...
        this.zza.zzq().zza((Runnable) new zzjt(this, componentName));
    }
