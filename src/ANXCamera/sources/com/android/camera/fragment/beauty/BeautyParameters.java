...
public class BeautyParameters {
    ...
    private void setBeautyParameters() {
        ...
        if (EffectController.getInstance().isStickerEnable()) {
            IntelligentBeautyProcessor intelligentBeautyProcessor = this.mStickerMakeupProcessor;
            if (intelligentBeautyProcessor != null) {
                this.mStickerMakeupProcessor.setBeautyParamsDegree(getProcessorBeautyParams(intelligentBeautyProcessor, beautyShowLevel));
                return;
            }
            return;
        }
        IntelligentBeautyProcessor intelligentBeautyProcessor2 = this.mMakeupProcessor;
        if (intelligentBeautyProcessor2 != null) {
            this.mMakeupProcessor.setBeautyParamsDegree(getProcessorBeautyParams(intelligentBeautyProcessor2, beautyShowLevel));
        }
    }
