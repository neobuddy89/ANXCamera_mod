    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float f2, Transformation transformation) {
                ...
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((i + ((int) (((float) (abs - i)) * f2))) - swipeRefreshLayout2.mCircleView.getTop());
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        AnonymousClass4 r0 = new Animation() {
            public void applyTransformation(float f2, Transformation transformation) {
                ...
                int i = i;
                circularProgressDrawable.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f2)));
            }
        };
        r0.setDuration(300);
