...
final class zzie {
    private static final zzif zza = ((!(zzib.zza() && zzib.zzb()) || zzdr.zza()) ? new zzii() : new zzik());
    ...
    static String zzb(byte[] bArr, int i, int i2) throws zzfo {
    ...
    public static int zzd(byte[] bArr, int i, int i2) {
        ...
        if (i3 == 2) {
            return zzb((int) b2, (int) bArr[i], (int) bArr[i + 1]);
        }
