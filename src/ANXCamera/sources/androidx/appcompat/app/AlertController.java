        ...
        private void createListView(final AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                if (this.mCursor != null) {
                    ...
                    r1 = simpleCursorAdapter;
                } else {
                    r1 = this.mAdapter != null ? this.mAdapter : new CheckedItemAdapter(this.mContext, i, 16908308, this.mItems);
                }
            } else if (this.mCursor == null) {
                final RecycleListView recycleListView2 = recycleListView;
                AnonymousClass1 r12 = new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, 16908308, this.mItems) {
                ...
                AnonymousClass2 r13 = new CursorAdapter(this.mContext, this.mCursor, false) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
                    public void onScrollChange(NestedScrollView nestedScrollView, int i, int i2, int i3, int i4) {
                        AlertController.manageScrollIndicators(nestedScrollView, view2, view3);
                    }
                });
                this.mScrollView.post(new Runnable() {
                    public void run() {
                        AlertController.manageScrollIndicators(AlertController.this.mScrollView, view2, view3);
                    }
                });
                return;
            }
            ...
            if (listView != null) {
                listView.setOnScrollListener(new AbsListView.OnScrollListener() {
                    public void onScroll(AbsListView absListView, int i, int i2, int i3) {
                        AlertController.manageScrollIndicators(absListView, view2, view3);
                    }
                ...
                this.mListView.post(new Runnable() {
                    public void run() {
                        AlertController.manageScrollIndicators(AlertController.this.mListView, view2, view3);
                    }
                });
                return;
            }
