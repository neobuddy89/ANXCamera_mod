...
.method private tryToCloseSession()V
    ...
    const-string v0, "tryToCloseSession: ignore"
...
.method public configCaptureSession(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/camera/core/ImageProcessor;->setTaskSession(Lcom/xiaomi/engine/TaskSession;)V
...
.method public getToken()I
    ...
    iget p0, p0, Lcom/xiaomi/camera/core/PostProcessor;->mToken:I
...
.method public isStopping()Z
    ...
    iget-boolean p0, p0, Lcom/xiaomi/camera/core/PostProcessor;->mShouldDestroyWhenTasksFinished:Z
...
.method public needWaitAlgorithmEngine()Z
    ...
    iget p0, p0, Lcom/xiaomi/camera/core/PostProcessor;->mMaxParallelRequestNumber:I
    ...
    const-string v2, "needWaitAlgorithmEngine: return "
...
.method public needWaitImageClose()Z
    ...
    const-string v2, "needWaitImageClose: return "
