    ...
    private void createHorizontalChain(int i, int i2, int i3, int i4, int[] iArr, float[] fArr, int i5, int i6, int i7) {
        ...
        if (iArr2.length < 2) {
            ...
            for (int i9 = 1; i9 < iArr2.length; i9++) {
                int i10 = iArr2[i9];
                connect(iArr2[i9], i6, iArr2[i9 - 1], i7, -1);
                connect(iArr2[i9 - 1], i7, iArr2[i9], i6, -1);
                if (fArr2 != null) {
                    get(iArr2[i9]).horizontalWeight = fArr2[i9];
                }
            }
    ...
    private String sideToString(int i) {
        switch (i) {
            ...
            case 5:
                return "baseline";
            case 6:
                return MistatsConstants.BaseEvent.START;
            case 7:
                return "end";
            default:
                return "undefined";
    ...
    public void createVerticalChain(int i, int i2, int i3, int i4, int[] iArr, float[] fArr, int i5) {
        ...
        if (iArr2.length < 2) {
            ...
            for (int i7 = 1; i7 < iArr2.length; i7++) {
                int i8 = iArr2[i7];
                connect(iArr2[i7], 3, iArr2[i7 - 1], 4, 0);
                connect(iArr2[i7 - 1], 4, iArr2[i7], 3, 0);
                if (fArr2 != null) {
                    get(iArr2[i7]).verticalWeight = fArr2[i7];
                }
            }
