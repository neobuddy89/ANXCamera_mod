...
public class PortraitNewbieDialogFragment extends BaseDialogFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        View inflate = DataRepository.dataItemFeature().oe() ? layoutInflater.inflate(R.layout.fragment_dialog_portait_lighting_hint, viewGroup, false) : layoutInflater.inflate(R.layout.fragment_dialog_portait_hint, viewGroup, false);
