...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        intent2.addFlags(WideSelfieEngine.MPAF_RGB_BASE);
        ...
        try {
            ...
            if (columnString2 != null) {
                if (SuggestionsAdapter.getColumnString(cursor, "suggest_intent_data_id") != null) {
                    str2 = columnString2 + "/" + Uri.encode(r3);
                    return createIntent(columnString, str2 != null ? null : Uri.parse(str2), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i, str);
                }
            }
            str2 = columnString2;
            return createIntent(columnString, str2 != null ? null : Uri.parse(str2), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_extra_data"), SuggestionsAdapter.getColumnString(cursor, "suggest_intent_query"), i, str);
