...
public class LifecycleRegistry extends Lifecycle {
    ...
    private void forwardPass(LifecycleOwner lifecycleOwner) {
        c<K, V>.d ia = this.mObserverMap.ia();
        while (ia.hasNext() && !this.mNewEventOccurred) {
    ...
    private boolean isSynced() {
        ...
        Lifecycle.State state2 = this.mObserverMap.ja().getValue().mState;
    ...
    private void sync() {
        ...
        while (!isSynced()) {
            ...
            Map.Entry<LifecycleObserver, ObserverWithState> ja = this.mObserverMap.ja();
            if (!this.mNewEventOccurred && ja != null && this.mState.compareTo(ja.getValue().mState) > 0) {
