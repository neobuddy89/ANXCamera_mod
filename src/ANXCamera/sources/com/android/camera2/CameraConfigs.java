...
public class CameraConfigs {
    ...
    public boolean isParallelDualShotType() {
        return getShotType() == 6 || getShotType() == -7;
    }
    ...
    public void setGlobalWatermark() {
        if (!Util.isStringValueContained((Object) "global", (List<? extends CharSequence>) this.mWaterMarkAppliedList)) {
    ...
    public void setNewWatermark(boolean z) {
        boolean isStringValueContained = Util.isStringValueContained((Object) "new", (List<? extends CharSequence>) this.mWaterMarkAppliedList);
        if (z) {
            if (!isStringValueContained) {
