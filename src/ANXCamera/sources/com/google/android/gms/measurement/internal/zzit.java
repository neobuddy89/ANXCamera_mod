        ...
        if (!zzt().zze(str2, zzap.zzbg)) {
            ...
            try {
                ...
                if (zzb2 == null) {
                    ...
                    zzbr.zzg.zza zza3 = zzbr.zzg.zzbf().zza(1).zza("android");
                    ...
                    try {
                        ...
                        if (zzlb == null || zzlb.zze == null) {
                            zzlb zzlb2 = new zzlb(zzc2, "auto", "_lte", zzm().currentTimeMillis(), 0L);
                            zza5.add(zzlb2);
                            zzi().zza(zzlb2);
                        }
                        if (zzt().zze(zzc2, zzap.zzbd)) {
                            ...
                            if (zzg2.zzl().zzj()) {
                                ...
                                if (zzb2.zzaf() && zzg2.zzj().zze(zzc3)) {
                                    ...
                                    zzlb zzlb3 = new zzlb(zzc3, "auto", "_npa", zzg2.zzm().currentTimeMillis(), 1L);
                                    zza5.add(zzlb3);
                                }
                            }
                        }
                        ...
                        if (zza7 == null) {
                            ...
                            bundle = zzb3;
                            bArr = null;
                            zzaj zzaj2 = new zzaj(str, zzan2.zza, 0, 0, zzan2.zzd, 0, (Long) null, (Long) null, (Long) null, (Boolean) null);
                            zzaj = zzaj2;
                            j = 0;
                        } else {
                            zzg = zzb2;
                        ...
                        zza9.zzc((Iterable<? extends zzbr.zza>) e_().zza(zzg.zzc(), Collections.emptyList(), zza9.zzd(), Long.valueOf(zzb4.zzf()), Long.valueOf(zzb4.zzf())));
                        if (zzb4.zze()) {
                        ...
                        try {
                            ...
                            zzr().zzf().zza("Data loss. Failed to bundle and serialize. appId", zzfj.zza(str), e2);
                            return bArr;
                        }
