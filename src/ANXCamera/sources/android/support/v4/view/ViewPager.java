...
public class ViewPager extends ViewGroup {
    ...
    private boolean pageScrolled(int i) {
        if (this.mItems.size() != 0) {
            ...
            float f3 = ((((float) i) / f2) - infoForCurrentScrollPosition.offset) / (infoForCurrentScrollPosition.widthFactor + (((float) i2) / f2));
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (i != -1) {
                ...
                if (i2 != 0 && !isGutterDrag(this.mLastMotionX, f2)) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor) {
                    ...
                    if (infoForChild != null) {
                        float f2 = (float) i18;
                        int i20 = ((int) (infoForChild.offset * f2)) + i12;
        ...
        for (int i14 = 0; i14 < childCount2; i14++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (layoutParams2 == null || !layoutParams2.isDecor) {
                    childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) i5) * layoutParams2.widthFactor), 1073741824), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                    ...
                    for (int i11 = this.mCurItem - 1; i11 >= 0; i11--) {
                        if (f2 < paddingLeft || i11 >= max) {
                            if (itemInfo4 == null || i11 != itemInfo4.position) {
                                f2 += addNewItem(i11, i9 + 1).widthFactor;
                                i10++;
                                if (i9 >= 0) {
    ...
    public void smoothScrollTo(int i, int i2, int i3) {
        ...
        int abs = Math.abs(i3);
        int min = Math.min(abs > 0 ? Math.round(Math.abs(distanceInfluenceForSnapDuration / ((float) abs)) * 1000.0f) * 4 : (int) (((((float) Math.abs(i6)) / ((f2 * this.mAdapter.getPageWidth(this.mCurItem)) + ((float) this.mPageMargin))) + 1.0f) * 100.0f), MAX_SETTLE_DURATION);
