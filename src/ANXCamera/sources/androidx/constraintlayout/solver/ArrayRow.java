...
public class ArrayRow implements LinearSystem.Row {
    ...
    public ArrayRow createRowCentering(SolverVariable solverVariable, SolverVariable solverVariable2, int i, float f2, SolverVariable solverVariable3, SolverVariable solverVariable4, int i2) {
        ...
        if (f2 == 0.5f) {
            ...
            this.variables.put(solverVariable4, f2 * 1.0f);
            if (i > 0 || i2 > 0) {
                this.constantValue = (((float) (-i)) * (1.0f - f2)) + (((float) i2) * f2);
            }
        }
        return this;
    }
    ...
    public ArrayRow createRowEqualDimension(float f2, float f3, float f4, SolverVariable solverVariable, int i, SolverVariable solverVariable2, int i2, SolverVariable solverVariable3, int i3, SolverVariable solverVariable4, int i4) {
        ...
        int i6 = i3;
        SolverVariable solverVariable8 = solverVariable4;
        int i7 = i4;
        if (f3 == 0.0f || f2 == f4) {
            this.constantValue = (float) (((-i5) - i2) + i6 + i7);
            this.variables.put(solverVariable5, 1.0f);
            this.variables.put(solverVariable6, -1.0f);
            this.variables.put(solverVariable8, 1.0f);
            this.variables.put(solverVariable7, -1.0f);
        } else {
            float f5 = (f2 / f3) / (f4 / f3);
            this.constantValue = ((float) ((-i5) - i2)) + (((float) i6) * f5) + (((float) i7) * f5);
            this.variables.put(solverVariable5, 1.0f);
            this.variables.put(solverVariable6, -1.0f);
            this.variables.put(solverVariable8, f5);
            this.variables.put(solverVariable7, -f5);
        }
        return this;
    }
