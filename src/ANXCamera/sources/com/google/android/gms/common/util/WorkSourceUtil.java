...
public class WorkSourceUtil {
    ...
    private static Method zzx() {
        try {
            return WorkSource.class.getMethod(MistatsConstants.BaseEvent.ADD, new Class[]{Integer.TYPE});
        } catch (Exception e2) {
            return null;
        }
    }
    ...
    private static Method zzy() {
        if (PlatformVersion.isAtLeastJellyBeanMR2()) {
            try {
                return WorkSource.class.getMethod(MistatsConstants.BaseEvent.ADD, new Class[]{Integer.TYPE, String.class});
            } catch (Exception e2) {
            }
        }
        return null;
