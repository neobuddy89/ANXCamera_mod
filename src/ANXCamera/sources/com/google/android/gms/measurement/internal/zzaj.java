...
final class zzaj {
    ...
    public final zzaj zza(long j) {
        zzaj zzaj = new zzaj(this.zza, this.zzb, this.zzc, this.zzd, this.zze, j, this.zzg, this.zzh, this.zzi, this.zzj, this.zzk);
        return zzaj;
    }

    /* access modifiers changed from: package-private */
    public final zzaj zza(long j, long j2) {
        zzaj zzaj = new zzaj(this.zza, this.zzb, this.zzc, this.zzd, this.zze, this.zzf, j, Long.valueOf(j2), this.zzi, this.zzj, this.zzk);
        return zzaj;
    }

    /* access modifiers changed from: package-private */
    public final zzaj zza(Long l, Long l2, Boolean bool) {
        zzaj zzaj = new zzaj(this.zza, this.zzb, this.zzc, this.zzd, this.zze, this.zzf, this.zzg, this.zzh, l, l2, (bool == null || bool.booleanValue()) ? bool : null);
        return zzaj;
    }
}
