...
public class WakeLockTracker {
    ...
    public void registerDeadlineEvent(Context context, String str, String str2, String str3, int i, List<String> list, boolean z, long j) {
        if (zzw()) {
            WakeLockEvent wakeLockEvent = new WakeLockEvent(System.currentTimeMillis(), 16, str, i, StatsUtils.zza(list), (String) null, j, zza.zzg(context), str2, StatsUtils.zzi(context.getPackageName()), zza.zzh(context), 0, str3, z);
