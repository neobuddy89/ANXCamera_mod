...
public class GoogleApi<O extends Api.ApiOptions> {
    ...
    public ClientSettings.Builder createClientSettingsBuilder() {
        ...
        if (o2 instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) {
            GoogleSignInAccount googleSignInAccount = ((Api.ApiOptions.HasGoogleSignInAccountOptions) o2).getGoogleSignInAccount();
            if (googleSignInAccount != null) {
                account = googleSignInAccount.getAccount();
                ClientSettings.Builder account2 = builder.setAccount(account);
                o = this.zabh;
                if (o instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) {
                    GoogleSignInAccount googleSignInAccount2 = ((Api.ApiOptions.HasGoogleSignInAccountOptions) o).getGoogleSignInAccount();
        ...
        ClientSettings.Builder account22 = builder.setAccount(account);
        o = this.zabh;
        if (o instanceof Api.ApiOptions.HasGoogleSignInAccountOptions) {
        }
        set = Collections.emptySet();
