...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.dispatchNestedPreScroll(i6, i7, access$500, (int[]) null, 1)) {
                    i6 -= access$500[0];
                    i7 -= access$500[1];
                }
                RecyclerView recyclerView = RecyclerView.this;
                ...
                if (!RecyclerView.this.dispatchNestedScroll(i4, i3, i2, i, (int[]) null, 1) && !(i2 == 0 && i == 0)) {
    ...
    private void pullGlows(float f2, float f3, float f4, float f5) {
        ...
        if (f3 < 0.0f) {
            ensureLeftGlow();
            EdgeEffectCompat.onPull(this.mLeftGlow, (-f3) / ((float) getWidth()), 1.0f - (f4 / ((float) getHeight())));
        } else if (f3 > 0.0f) {
            ensureRightGlow();
            EdgeEffectCompat.onPull(this.mRightGlow, f3 / ((float) getWidth()), f4 / ((float) getHeight()));
        } else {
            z = false;
            if (f5 >= 0.0f) {
                ensureTopGlow();
                EdgeEffectCompat.onPull(this.mTopGlow, (-f5) / ((float) getHeight()), f2 / ((float) getWidth()));
            } else if (f5 > 0.0f) {
                ensureBottomGlow();
                EdgeEffectCompat.onPull(this.mBottomGlow, f5 / ((float) getHeight()), 1.0f - (f2 / ((float) getWidth())));
            } else {
                z2 = z;
            }
    ...
    public void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ...
            if (this.mGapWorker == null) {
                ...
                gapWorker.mFrameIntervalNs = (long) (1.0E9f / f2);
    ...
    public boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        int i11 = i6;
        if (dispatchNestedScroll(i3, i6, i5, i4, this.mScrollOffset, 0)) {
            int i12 = this.mLastTouchX;
            int[] iArr2 = this.mScrollOffset;
            this.mLastTouchX = i12 - iArr2[0];
            ...
            if (motionEvent2 != null && !MotionEventCompat.isFromSource(motionEvent2, 8194)) {
                pullGlows(motionEvent.getX(), (float) i5, motionEvent.getY(), (float) i4);
            }
            considerReleasingGlowsOnScroll(i, i2);
        }
        int i14 = i11;
        if (!(i3 == 0 && i14 == 0)) {
            dispatchOnScrolled(i3, i14);
        }
        if (!awakenScrollBars()) {
            invalidate();
        }
        return (i3 == 0 && i14 == 0) ? false : true;
    }
