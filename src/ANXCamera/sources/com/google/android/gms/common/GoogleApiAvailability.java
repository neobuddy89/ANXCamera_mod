...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        return zaa((Context) activity, i, DialogRedirect.getInstance(activity, getErrorResolutionIntent(activity, i, SupportedConfigFactory.CLOSE_BY_BURST_SHOOT), i2), onCancelListener);
    }
    ...
    public final boolean zaa(Activity activity, LifecycleFragment lifecycleFragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        Dialog zaa2 = zaa((Context) activity, i, DialogRedirect.getInstance(lifecycleFragment, getErrorResolutionIntent(activity, i, SupportedConfigFactory.CLOSE_BY_BURST_SHOOT), 2), onCancelListener);
        if (zaa2 == null) {
            return false;
        }
