...
# direct methods
.method public constructor <init>([BLandroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;III)V
    .locals 0
    ...
    iput-object p4, p0, Lcom/android/camera/storage/RawImageSaveRequest;->title:Ljava/lang/String;

    iput p5, p0, Lcom/android/camera/storage/RawImageSaveRequest;->width:I

    iput p6, p0, Lcom/android/camera/storage/RawImageSaveRequest;->height:I
    ...
    iput p7, p0, Lcom/android/camera/storage/RawImageSaveRequest;->orientation:I
...
.method public save()V
    ...
    iget v5, p0, Lcom/android/camera/storage/RawImageSaveRequest;->width:I

    iget v6, p0, Lcom/android/camera/storage/RawImageSaveRequest;->height:I

    iget v7, p0, Lcom/android/camera/storage/RawImageSaveRequest;->orientation:I

    invoke-static/range {v0 .. v7}, Lcom/android/camera/storage/Storage;->addRawImage(Landroid/content/Context;Ljava/lang/String;Landroid/hardware/camera2/CameraCharacteristics;Landroid/hardware/camera2/CaptureResult;[BIII)Landroid/net/Uri;
