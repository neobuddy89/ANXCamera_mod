...
final class zzds extends zzdo<Boolean> implements zzfl<Boolean>, zzha, RandomAccess {
    ...
    static {
        zzds zzds = new zzds(new boolean[0], 0);
        zza = zzds;
        zzds.h_();
    }
    ...
    public final boolean addAll(Collection<? extends Boolean> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzds.zzb, 0, this.zzb, this.zzc, zzds.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzds zzds = (zzds) obj;
        if (this.zzc != zzds.zzc) {
            return false;
        }
        boolean[] zArr = zzds.zzb;
