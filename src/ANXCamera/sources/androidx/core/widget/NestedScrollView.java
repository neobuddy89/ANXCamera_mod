    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                } else if (!dispatchNestedPreFling(0.0f, (float) (-yVelocity))) {
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        int[] iArr = this.mScrollConsumed;
                        iArr[1] = 0;
                        dispatchNestedScroll(0, scrollY2, 0, i - scrollY2, this.mScrollOffset, 0, iArr);
                        int i7 = this.mLastMotionY;
                        int[] iArr2 = this.mScrollOffset;
                        this.mLastMotionY = i7 - iArr2[1];
                        this.mNestedYOffset += iArr2[1];
                        if (z) {
                            int i8 = i - this.mScrollConsumed[1];
                            ensureGlows();
                            int i9 = scrollY + i8;
                            if (i9 < 0) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowTop, ((float) i8) / ((float) getHeight()), motionEvent2.getX(i6) / ((float) getWidth()));
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                    int i10 = i4;
                                } else {
                                ...
                                int i12 = i6;
                                if (i9 > i4) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowBottom, ((float) i8) / ((float) getHeight()), 1.0f - (motionEvent2.getX(i12) / ((float) getWidth())));
                                    if (!this.mEdgeGlowTop.isFinished()) {
    ...
    public final void smoothScrollBy(int i, int i2) {
        if (getChildCount() != 0) {
            if (AnimationUtils.currentAnimationTimeMillis() - this.mLastScroll > 250) {
                ...
                int scrollY = getScrollY();
                this.mScroller.startScroll(getScrollX(), scrollY, 0, Math.max(0, Math.min(scrollY + i2, Math.max(0, height - height2))) - scrollY);
