...
.field private static Gl:Ljava/lang/Integer; = null
...
# instance fields
.field private final Bl:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;

.field private Cl:Landroid/view/View$OnAttachStateChangeListener;
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget;->Bl:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;
...
.method public constructor <init>(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0}, Lcom/bumptech/glide/request/target/ViewTarget;->Dh()Lcom/bumptech/glide/request/target/ViewTarget;
...
.method public static H(I)V
    ...
    sget-object v0, Lcom/bumptech/glide/request/target/ViewTarget;->Gl:Ljava/lang/Integer;

    if-nez v0, :cond_0

    sget-boolean v0, Lcom/bumptech/glide/request/target/ViewTarget;->Fl:Z
    ...
    sput-object p0, Lcom/bumptech/glide/request/target/ViewTarget;->Gl:Ljava/lang/Integer;
...
.method private _k()V
    ...
    iget-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget;->Cl:Landroid/view/View$OnAttachStateChangeListener;

    if-eqz v0, :cond_1

    iget-boolean v1, p0, Lcom/bumptech/glide/request/target/ViewTarget;->El:Z
    ...
    iput-boolean v0, p0, Lcom/bumptech/glide/request/target/ViewTarget;->El:Z
...
.method private setTag(Ljava/lang/Object;)V
    ...
    sput-boolean v0, Lcom/bumptech/glide/request/target/ViewTarget;->Fl:Z
...
# virtual methods
.method public final Ah()Lcom/bumptech/glide/request/target/ViewTarget;
    .locals 1
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
    ...
    iput-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget;->Cl:Landroid/view/View$OnAttachStateChangeListener;

    invoke-direct {p0}, Lcom/bumptech/glide/request/target/ViewTarget;->_k()V
...
.method Bh()V
    ...
    iput-boolean v1, p0, Lcom/bumptech/glide/request/target/ViewTarget;->Dl:Z

    invoke-interface {v0}, Lcom/bumptech/glide/request/c;->pause()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/bumptech/glide/request/target/ViewTarget;->Dl:Z
...
.method public final Dh()Lcom/bumptech/glide/request/target/ViewTarget;
    .locals 2
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
    ...
    iget-object v0, p0, Lcom/bumptech/glide/request/target/ViewTarget;->Bl:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;

    const/4 v1, 0x1

    iput-boolean v1, v0, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->Jl:Z
...
.method public a(Lcom/bumptech/glide/request/target/n;)V
    ...
    iget-object p0, p0, Lcom/bumptech/glide/request/target/ViewTarget;->Bl:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;
...
.method public b(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, Lcom/bumptech/glide/request/target/ViewTarget;->Bl:Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;

    invoke-virtual {p1}, Lcom/bumptech/glide/request/target/ViewTarget$SizeDeterminer;->Fh()V

    iget-boolean p1, p0, Lcom/bumptech/glide/request/target/ViewTarget;->Dl:Z

    if-nez p1, :cond_0

    invoke-direct {p0}, Lcom/bumptech/glide/request/target/ViewTarget;->al()V
