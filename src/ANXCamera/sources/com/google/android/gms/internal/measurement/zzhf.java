...
final class zzhf {
    ...
    static int zza(int i, Object obj, zzhd zzhd) {
        return obj instanceof zzft ? zzen.zza(i, (zzft) obj) : zzen.zzb(i, (zzgo) obj, zzhd);
    }
    ...
    static int zza(int i, List<?> list, zzhd zzhd) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            Object obj = list.get(i2);
            zze += obj instanceof zzft ? zzen.zza((zzft) obj) : zzen.zza((zzgo) obj, zzhd);
        }
        return zze;
    }
    ...
    private static zzhv<?, ?> zza(boolean z) {
        try {
            ...
            return (zzhv) zze.getConstructor(new Class[]{Boolean.TYPE}).newInstance(new Object[]{Boolean.valueOf(z)});
        } catch (Throwable th) {
            return null;
        }
    }

    static <UT, UB> UB zza(int i, int i2, UB ub, zzhv<UT, UB> zzhv) {
        if (ub == null) {
            ub = zzhv.zza();
        }
        zzhv.zza(ub, i, (long) i2);
        return ub;
    }
    ...
    static <T, FT extends zzey<FT>> void zza(zzes<FT> zzes, T t, T t2) {
        zzew<FT> zza2 = zzes.zza((Object) t2);
        if (!zza2.zza.isEmpty()) {
            zzes.zzb(t).zza(zza2);
        }
    }

    static <T> void zza(zzgh zzgh, T t, T t2, long j) {
        zzib.zza((Object) t, j, zzgh.zza(zzib.zzf(t, j), zzib.zzf(t2, j)));
    }

    static <T, UT, UB> void zza(zzhv<UT, UB> zzhv, T t, T t2) {
        zzhv.zza((Object) t, zzhv.zzc(zzhv.zzb(t), zzhv.zzb(t2)));
    }
