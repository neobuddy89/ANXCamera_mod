...
public class MenuPopupHelper implements MenuHelper {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v0, resolved type: androidx.appcompat.view.menu.StandardMenuPopup} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v2, resolved type: androidx.appcompat.view.menu.CascadingMenuPopup} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r7v8, resolved type: androidx.appcompat.view.menu.StandardMenuPopup} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v3, resolved type: androidx.appcompat.view.menu.StandardMenuPopup} */
