...
interface zzhe {
    ...
    <T> T zza(zzhd<T> zzhd, zzeq zzeq) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzhd<T> zzhd, zzeq zzeq) throws IOException;

    <K, V> void zza(Map<K, V> map, zzgf<K, V> zzgf, zzeq zzeq) throws IOException;
