...
class MimojiImageWaterMark extends WaterMark {
    ...
    private int mHeight = ((int) (((double) this.mHeight) * 1.04d));
    private BitmapTexture mImageTexture;
    private int mPaddingX;
    private int mPaddingY;
    private int mWidth = ((int) (((double) this.mWidth) * 1.04d));

    public MimojiImageWaterMark(Bitmap bitmap, int i, int i2, int i3, float f2, float f3, float f4) {
        super(i, i2, i3);
