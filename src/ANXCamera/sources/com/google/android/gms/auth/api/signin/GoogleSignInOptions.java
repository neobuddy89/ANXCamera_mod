...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    public static final class Builder {
        ...
        public final GoogleSignInOptions build() {
            ...
            GoogleSignInOptions googleSignInOptions = new GoogleSignInOptions(3, new ArrayList(this.mScopes), this.zax, this.zay, this.zaz, this.zaaa, this.zaab, this.zaac, this.zaag, (zac) null);
    ...
    public boolean equals(Object obj) {
        ...
        try {
            ...
            if (this.zaad.size() <= 0) {
                if (googleSignInOptions.zaad.size() <= 0) {
                    if (this.zaw.size() == googleSignInOptions.getScopes().size()) {
                        if (this.zaw.containsAll(googleSignInOptions.getScopes())) {
                            if (this.zax != null) {
                                if (this.zax.equals(googleSignInOptions.getAccount())) {
                                }
                            }
                            if (TextUtils.isEmpty(this.zaab)) {
