    ...
    public void subscribeActual(Subscriber<? super Flowable<T>> subscriber) {
        ...
        if (j == j2) {
            ...
            if (j3 == Long.MAX_VALUE) {
                ...
                flowable.subscribe((FlowableSubscriber<? super T>) windowExactUnboundedSubscriber);
                return;
            }
            ...
            flowable2.subscribe((FlowableSubscriber<? super T>) windowExactBoundedSubscriber);
            return;
        }
        Flowable<T> flowable3 = this.source;
        ...
        flowable3.subscribe((FlowableSubscriber<? super T>) windowSkipSubscriber);
    }
}
