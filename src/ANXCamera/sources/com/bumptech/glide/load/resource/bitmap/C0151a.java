...
public class C0151a<DataType> implements h<DataType, BitmapDrawable> {
    private final h<DataType, Bitmap> decoder;
    private final Resources resources;

    public C0151a(Context context, h<DataType, Bitmap> hVar) {
        this(context.getResources(), hVar);
    }

    @Deprecated
    public C0151a(Resources resources2, d dVar, h<DataType, Bitmap> hVar) {
        this(resources2, hVar);
    }

    public C0151a(@NonNull Resources resources2, @NonNull h<DataType, Bitmap> hVar) {
