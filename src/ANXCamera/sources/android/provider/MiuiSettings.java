...
public class MiuiSettings {
    ...
    public static final class Key {
        ...
        public static final String LONG_PRESS_POWER_KEY = "long_press_power_key";
        ...
        public static String getKeyAndGestureShortcutFunction(Context context, String str) {
            ...
            if (TextUtils.isEmpty(keyAndGestureShortcutSetFunction)) {
                if (LONG_PRESS_POWER_KEY.equals(str)) {
                    keyAndGestureShortcutSetFunction = null;
                } else if (DOUBLE_CLICK_POWER_KEY.equals(str)) {
                    keyAndGestureShortcutSetFunction = null;
                } else if (THREE_GESTURE_DOWN.equals(str)) {
                    keyAndGestureShortcutSetFunction = SCREEN_SHOT;
                } else if (LONG_PRESS_HOME_KEY.equals(str)) {
                    keyAndGestureShortcutSetFunction = !Build.IS_GLOBAL_BUILD ? LAUNCH_VOICE_ASSISTANT : LAUNCH_GOOGLE_SEARCH;
                } else if (LONG_PRESS_MENU_KEY.equals(str)) {
                    keyAndGestureShortcutSetFunction = "show_menu";
                } else if (LONG_PRESS_MENU_KEY_WHEN_LOCK.equals(str)) {
                    keyAndGestureShortcutSetFunction = TURN_ON_TORCH;
                } else if (LONG_PRESS_BACK_KEY.equals(str)) {
                    keyAndGestureShortcutSetFunction = null;
                } else if (KEY_COMBINATION_POWER_HOME.equals(str)) {
                    keyAndGestureShortcutSetFunction = null;
                } else if (KEY_COMBINATION_POWER_BACK.equals(str)) {
                    keyAndGestureShortcutSetFunction = null;
                } else if (KEY_COMBINATION_POWER_MENU.equals(str)) {
                    keyAndGestureShortcutSetFunction = null;
                }
            }
            if ("none".equals(keyAndGestureShortcutSetFunction)) {
                return null;
            }
    ...
    public static final class ScreenEffect {
        ...
        public static final boolean SUPPORT_UNLIMITED_COLOR_MODE = SystemProperties.getBoolean("ro.all_modes.colorpick_adjust", false);
        ...
        private static int getDefaultSaturation() {
            int i = 10;
            if (FeatureParser.getBoolean(d.IS_HONGMI, false)) {
                i = 11;
            }
    ...
    public static class Secure extends SystemSettings.Secure {
        ...
        public static String FINGERPRINT_UNLOCK_TYPE = "fingerprint_unlock_type";
        ...
        public static void showApplyPasswordConfirmDialog(final Activity activity, final DialogInterface.OnClickListener onClickListener, final String str, String str2) {
            ...
            new AlertDialog.Builder(activity).setCancelable(false).setIconAttribute(16843605).setTitle(activity.getString(286130244, new Object[]{str2})).setMessage(activity.getString(286130243, new Object[]{str2})).setPositiveButton(286130242, r0).setNegativeButton(286130271, r0).create().show();
        }

        private static void showConfirmDialog(Activity activity, DialogInterface.OnClickListener onClickListener) {
            new AlertDialog.Builder(activity).setCancelable(false).setIconAttribute(16843605).setTitle(286130438).setMessage(286130437).setPositiveButton(286130436, onClickListener).setNegativeButton(286130271, onClickListener).create().show();
        }
    ...
    public static final class SilenceMode {
        ...
        public static final String[] MISTAT_RINGERMODE_LIST = {"normal", "DND", "null", "silence", "new"};
    ...
    public static class System extends SystemSettings.System {
        ...
        public static final String CLOUD_SLAVE_WIFI_SUPPORT = "cloud_slave_wifi_support";
        ...
        public static final Set<String> PUBLIC_SETTINGS_OPEN = new ArraySet();
        ...
        public static final String SLAVE_WIFI_ON = "slave_wifi_on";
        public static final String SLAVE_WIFI_SSID = "slave_wifi_ssid";
        ...
        public static final String SOFTAP_REPORTED_FREQUENCY = "softap_reported_frequency";
        ...
        public static final int STATUS_BAR_SHOW_NOTIFICATION_ICON_DEFAULT = 1;
        ...
        public static final String WIFI_GENERATION = "wifi_generation";
        ...
        public static Rect getDisplayWindowSizeInSmartCover() {
            ...
            int[] iArr = {system.getInteger(285868082), system.getInteger(285868084), system.getInteger(285868083), system.getInteger(285868081)};
        ...
        public static int getShowCustomCarrierDefault() {
            return (miui.os.Build.IS_CM_CUSTOMIZATION_TEST || miui.os.Build.IS_CU_CUSTOMIZATION_TEST || miui.os.Build.IS_CT_CUSTOMIZATION_TEST || Resources.getSystem().getBoolean(285474856)) ? 1 : 0;
        }
    ...
    public static class Telephony {
        ...
        public static int getCallWaitingTone(Context context) {
            ...
            if (!"lithium".equals(aeonax.Build.ANXDEVICE) || i != 2) {
                return i;
            }
            return 0;
        }
