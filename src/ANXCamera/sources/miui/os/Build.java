...
public class Build extends android.os.Build {
    public static final String ANXDEVICE = SystemProperties.get("ro.product.vendor.device");
    ...
    public static final boolean IS_HONGMI2_TDSCDMA = "HM2013022".equals(ANXDEVICE);
    public static final boolean IS_HONGMI_THREE = ("lcsh92_wet_jb9".equals(ANXDEVICE) || "lcsh92_wet_tdd".equals(ANXDEVICE));
    public static final boolean IS_HONGMI_THREEX = "gucci".equals(ANXDEVICE);
    ...
    public static final boolean IS_HONGMI_THREE_LTE = "dior".equals(ANXDEVICE);
    ...
    public static final boolean IS_HONGMI_TWO = ("HM2013022".equals(ANXDEVICE) || "HM2013023".equals(ANXDEVICE) || IS_HONGMI_TWO_A || IS_HONGMI_TWO_S);
    public static final boolean IS_HONGMI_TWOS_LTE_MTK = "HM2014501".equals(ANXDEVICE);
    ...
    public static final boolean IS_HONGMI_TWOX_BR = "HM2014819".equals(ANXDEVICE);
    public static final boolean IS_HONGMI_TWOX_CM = ("HM2014813".equals(ANXDEVICE) || "HM2014112".equals(ANXDEVICE));
    public static final boolean IS_HONGMI_TWOX_CT = ("HM2014812".equals(ANXDEVICE) || "HM2014821".equals(ANXDEVICE));
    public static final boolean IS_HONGMI_TWOX_CU = "HM2014811".equals(ANXDEVICE);
    public static final boolean IS_HONGMI_TWOX_IN = "HM2014818".equals(ANXDEVICE);
    public static final boolean IS_HONGMI_TWOX_LC = "lte26007".equals(ANXDEVICE);
    public static final boolean IS_HONGMI_TWOX_SA = "HM2014817".equals(ANXDEVICE);
    public static final boolean IS_HONGMI_TWO_A = "armani".equals(ANXDEVICE);
    public static final boolean IS_HONGMI_TWO_S = ("HM2014011".equals(ANXDEVICE) || "HM2014012".equals(ANXDEVICE));
    ...
    public static final boolean IS_MIFIVE = "virgo".equals(ANXDEVICE);
    public static final boolean IS_MIFOUR = ("cancro".equals(ANXDEVICE) && MODEL.startsWith("MI 4"));
    ...
    public static final boolean IS_MIONE = ("mione".equals(ANXDEVICE) || "mione_plus".equals(ANXDEVICE));
    public static final boolean IS_MIONE_CDMA = (IS_MIONE && hasMsm8660Property());
    public static final boolean IS_MIPAD = "mocha".equals(ANXDEVICE);
    public static final boolean IS_MITHREE = ("pisces".equals(ANXDEVICE) || ("cancro".equals(ANXDEVICE) && MODEL.startsWith("MI 3")));
    ...
    public static final boolean IS_MITWO = ("aries".equals(ANXDEVICE) || "taurus".equals(ANXDEVICE) || "taurus_td".equals(ANXDEVICE));
    ...
    public static final boolean IS_N7 = "flo".equals(ANXDEVICE);
