...
public class CaptureResultVendorTags {
    public static final VendorTag<CaptureResult.Key<AECFrameControl>> AEC_FRAME_CONTROL = create(C0074ic.INSTANCE, AECFrameControl.class);
    public static final VendorTag<CaptureResult.Key<Float>> AEC_LUX = create(C0133xc.INSTANCE, Float.class);
    ...
    public static final VendorTag<CaptureResult.Key<int[]>> AUTOZOOM_ACTIVE_OBJECTS = create(C0049cd.INSTANCE, int[].class);
    ...
    public static final VendorTag<CaptureResult.Key<float[]>> AUTOZOOM_OBJECT_BOUNDS_STABILIZED = create(C0048cc.INSTANCE, float[].class);
    ...
    public static final VendorTag<CaptureResult.Key<int[]>> AUTOZOOM_SELECTED_OBJECTS = create(C0098oc.INSTANCE, int[].class);
    public static final VendorTag<CaptureResult.Key<Integer>> AUTOZOOM_STATUS = create(Cd.INSTANCE, Integer.class);
    public static final VendorTag<CaptureResult.Key<float[]>> AUTOZOOM_TARGET_BOUNDS_STABILIZED = create(C0109rc.INSTANCE, float[].class);
    public static final VendorTag<CaptureResult.Key<float[]>> AUTOZOOM_TARGET_BOUNDS_ZOOMED = create(C0062fc.INSTANCE, float[].class);
    ...
    public static final VendorTag<CaptureResult.Key<Integer>> BEAUTY_BODY_SLIM_COUNT = create(C0066gc.INSTANCE, Integer.class);
    public static final VendorTag<CaptureResult.Key<Integer>> BEAUTY_CHIN = create(C0070hc.INSTANCE, Integer.class);
    public static final VendorTag<CaptureResult.Key<Integer>> BEAUTY_ENLARGE_EYE = create(C0039ad.INSTANCE, Integer.class);
    ...
    public static final VendorTag<CaptureResult.Key<Integer>> BEAUTY_HEAD_SLIM = create(C0113sc.INSTANCE, Integer.class);
    ...
    public static final VendorTag<CaptureResult.Key<Integer>> BEAUTY_NECK = create(C0141zc.INSTANCE, Integer.class);
    public static final VendorTag<CaptureResult.Key<Integer>> BEAUTY_NOSE = create(C0106qc.INSTANCE, Integer.class);
    public static final VendorTag<CaptureResult.Key<Integer>> BEAUTY_PUPIL_LINE = create(C0117tc.INSTANCE, Integer.class);
    public static final VendorTag<CaptureResult.Key<Integer>> BEAUTY_RISORIUS = create(C0053dc.INSTANCE, Integer.class);
    public static final VendorTag<CaptureResult.Key<Integer>> BEAUTY_SHOULDER_SLIM = create(gd.INSTANCE, Integer.class);
    public static final VendorTag<CaptureResult.Key<Integer>> BEAUTY_SKIN_COLOR = create(C0078jc.INSTANCE, Integer.class);
    ...
    public static final VendorTag<CaptureResult.Key<Integer>> BUTT_SLIM = create(C0129wc.INSTANCE, Integer.class);
    public static final VendorTag<CaptureResult.Key<Boolean>> CONTROL_ENABLE_REMOSAIC = create(C0086lc.INSTANCE, Boolean.class);
    public static final VendorTag<CaptureResult.Key<Byte>> DEPURPLE = create(C0125vc.INSTANCE, Byte.class);
    public static final VendorTag<CaptureResult.Key<byte[]>> DISTORTION_FPC_DATA = create(Gc.INSTANCE, byte[].class);
    public static VendorTag<CaptureResult.Key<byte[]>> EXIF_INFO_VALUES = create(C0058ec.INSTANCE, byte[].class);
    public static final VendorTag<CaptureResult.Key<Integer>> EYE_LIGHT_STRENGTH = create(od.INSTANCE, Integer.class);
    public static final VendorTag<CaptureResult.Key<Integer>> EYE_LIGHT_TYPE = create(C0090mc.INSTANCE, Integer.class);
    ...
    public static final VendorTag<CaptureResult.Key<Integer>> HDR_CHECKER_ADRC = create(C0094nc.INSTANCE, Integer.class);
    ...
    public static final VendorTag<CaptureResult.Key<MarshalQueryableASDScene.ASDScene[]>> SEMANTIC_SCENE = create(C0121uc.INSTANCE, MarshalQueryableASDScene.ASDScene[].class);
    public static final VendorTag<CaptureResult.Key<Byte>> SENSOR_HDR_ENABLE = create(C0102pc.INSTANCE, Byte.class);
    ...
    public static final VendorTag<CaptureResult.Key<float[]>> STATISTICS_FACE_FACESCORE = create(C0082kc.INSTANCE, float[].class);
    ...
    public static final VendorTag<CaptureResult.Key<Boolean>> SUPER_NIGHT_SCENE_ENABLED = create(C0044bd.INSTANCE, Boolean.class);
    ...
    public static final VendorTag<CaptureResult.Key<Byte>> ULTRA_WIDE_LENS_DISTORTION_CORRECTION_LEVEL = create(C0137yc.INSTANCE, Byte.class);
    ...
    public static final VendorTag<CaptureResult.Key<Integer>> WHOLE_BODY_SLIM = create(C0054dd.INSTANCE, Integer.class);
