...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.dataCollectionConfigStorage = new Lazy<>((Provider<DataCollectionConfigStorage>) FirebaseApp$$Lambda$1.lambdaFactory$(this, context));
    }
        ...
        synchronized (LOCK) {
            ...
            if (firebaseApp == null) {
                if (getAllAppNames().isEmpty()) {
                    ...
                    str2 = "Available app names: " + TextUtils.join(", ", r2);
                }
    ...
    public static FirebaseApp initializeApp(Context context, FirebaseOptions firebaseOptions, String str) {
        ...
        synchronized (LOCK) {
            ...
            firebaseApp = new FirebaseApp(applicationContext2, normalize, firebaseOptions);
