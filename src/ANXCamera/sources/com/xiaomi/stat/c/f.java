...
public class f {
    ...
    private int b() {
        boolean b2 = m.b(I.a());
        k.b("UploadPolicy getExperiencePlanPolicy: " + b2 + " isInternationalVersion= " + C0159b.e() + " isAnonymous= " + this.f435d);
        if (b2) {
            return 3;
        }
        return (!C0159b.e() || !this.f435d) ? 2 : 3;
    }

    private int c() {
        int e2 = C0159b.e(this.f436f);
        k.b("UploadPolicy getCustomPrivacyPolicy: state=" + e2);
        return e2 == 1 ? 3 : 1;
    }

    private int d() {
        return C0159b.d(this.f436f) ? c() : b();
    }

    private int e() {
        int a2 = l.a(I.a());
        int l = a(C0159b.l()) ? C0159b.l() : C0159b.i();
