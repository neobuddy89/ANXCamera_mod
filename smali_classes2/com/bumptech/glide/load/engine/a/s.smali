...
# instance fields
.field private final ah:Lcom/bumptech/glide/util/f;
...
.field private final bh:Landroid/support/v4/util/Pools$Pool;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/a/s;->ah:Lcom/bumptech/glide/util/f;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/a/s;->bh:Landroid/support/v4/util/Pools$Pool;
...
.method private j(Lcom/bumptech/glide/load/c;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/a/s;->bh:Landroid/support/v4/util/Pools$Pool;
    ...
    invoke-static {p1}, Lcom/bumptech/glide/util/l;->g([B)Ljava/lang/String;

    move-result-object p1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p0, p0, Lcom/bumptech/glide/load/engine/a/s;->bh:Landroid/support/v4/util/Pools$Pool;
...
.method public f(Lcom/bumptech/glide/load/c;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/a/s;->ah:Lcom/bumptech/glide/util/f;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/a/s;->ah:Lcom/bumptech/glide/util/f;
    ...
    :cond_0
    iget-object v2, p0, Lcom/bumptech/glide/load/engine/a/s;->ah:Lcom/bumptech/glide/util/f;

    monitor-enter v2

    :try_start_1
    iget-object p0, p0, Lcom/bumptech/glide/load/engine/a/s;->ah:Lcom/bumptech/glide/util/f;
