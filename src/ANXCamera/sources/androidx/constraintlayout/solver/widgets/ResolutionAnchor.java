                ...
                if (resolutionAnchor3 != null && resolutionAnchor3.state == 1) {
                    ...
                    if (resolutionAnchor4 != null) {
                        ...
                        if (resolutionAnchor5 != null && resolutionAnchor5.state == 1) {
                            ...
                            float f4 = z ? this.target.resolvedOffset - this.opposite.target.resolvedOffset : this.opposite.target.resolvedOffset - this.target.resolvedOffset;
                            if (this.myAnchor.mType == ConstraintAnchor.Type.LEFT || this.myAnchor.mType == ConstraintAnchor.Type.RIGHT) {
                                f2 = f4 - ((float) this.myAnchor.mOwner.getWidth());
                                f3 = this.myAnchor.mOwner.mHorizontalBiasPercent;
                            } else {
                                f2 = f4 - ((float) this.myAnchor.mOwner.getHeight());
                            ...
                            float f5 = (f2 - ((float) margin)) - ((float) margin2);
                            if (z) {
                                ResolutionAnchor resolutionAnchor7 = this.opposite;
                                resolutionAnchor7.resolvedOffset = resolutionAnchor7.target.resolvedOffset + ((float) margin2) + (f5 * f3);
                                this.resolvedOffset = (this.target.resolvedOffset - ((float) margin)) - ((1.0f - f3) * f5);
                            } else {
                                this.resolvedOffset = this.target.resolvedOffset + ((float) margin) + (f5 * f3);
                                ResolutionAnchor resolutionAnchor8 = this.opposite;
                                resolutionAnchor8.resolvedOffset = (resolutionAnchor8.target.resolvedOffset - ((float) margin2)) - ((1.0f - f3) * f5);
                            }
                            didResolve();
