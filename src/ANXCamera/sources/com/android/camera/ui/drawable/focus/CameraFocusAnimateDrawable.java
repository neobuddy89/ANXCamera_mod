...
public class CameraFocusAnimateDrawable extends Drawable implements Animatable {
    ...
    private void startNormalFocusSuccessAnimation() {
        ...
        ofFloat.setInterpolator(new CubicEaseInOutInterpolator() {
            public float getInterpolation(float f2) {
                float interpolation = CameraFocusAnimateDrawable.super.getInterpolation(f2);
    ...
    public void setCenter(int i, int i2) {
        ...
        float f3 = (float) i2;
        this.mMiddleY = f3;
        this.mPaintBigCircle.setMiddle(f2, f3, (float) BIG_RADIUS);
        this.mPaintEvAdjust.setMiddle(f2, f3, (float) BIG_RADIUS);
        this.mPaintEvAdjust.setShowLine(false);
        this.mPaintEvAdjust.setVisible(8);
        this.mPaintEvText.setMiddle(f2, f3, (float) BIG_RADIUS);
        this.mPaintCenterIndicator.setCenterFlag(1);
        this.mPaintCenterIndicator.setMiddle(f2, f3, (float) CENTER_BASE_RADIUS);
    }
