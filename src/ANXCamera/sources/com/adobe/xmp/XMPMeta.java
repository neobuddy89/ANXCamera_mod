...
public interface XMPMeta extends Cloneable {
    ...
    void setPropertyDouble(String str, String str2, double d2) throws XMPException;

    void setPropertyDouble(String str, String str2, double d2, PropertyOptions propertyOptions) throws XMPException;
