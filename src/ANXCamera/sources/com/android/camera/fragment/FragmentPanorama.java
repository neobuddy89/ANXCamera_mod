...
public class FragmentPanorama extends BaseFragment implements ModeProtocol.PanoramaProtocol, CameraScreenNail.RequestRenderListener, View.OnClickListener {
    ...
    public void initView(View view) {
        ...
        if (Util.isContentViewExtendToTopEdges() || Util.sIsnotchScreenHidden) {
    ...
    public void moveToDirection(int i) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(imageView, "translationX", new float[]{imageView.getTranslationX(), translationX});
        ...
        animatorSet.playSequentially(new Animator[]{ofFloat3, ofFloat4});
        AnimatorSet animatorSet2 = new AnimatorSet();
        animatorSet2.playTogether(new Animator[]{ofFloat, ofFloat2, animatorSet});
