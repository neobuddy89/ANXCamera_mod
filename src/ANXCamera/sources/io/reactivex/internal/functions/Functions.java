...
public final class Functions {
    ...
    static final class Array2Func<T1, T2, R> implements Function<Object[], R> {
        ...
        final BiFunction<? super T1, ? super T2, ? extends R> f609f;

        Array2Func(BiFunction<? super T1, ? super T2, ? extends R> biFunction) {
            this.f609f = biFunction;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 2) {
                return this.f609f.apply(objArr[0], objArr[1]);
            }
    ...
    static final class Array3Func<T1, T2, T3, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function3<T1, T2, T3, R> f610f;

        Array3Func(Function3<T1, T2, T3, R> function3) {
            this.f610f = function3;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 3) {
                return this.f610f.apply(objArr[0], objArr[1], objArr[2]);
            }
    ...
    static final class Array4Func<T1, T2, T3, T4, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function4<T1, T2, T3, T4, R> f611f;

        Array4Func(Function4<T1, T2, T3, T4, R> function4) {
            this.f611f = function4;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 4) {
                return this.f611f.apply(objArr[0], objArr[1], objArr[2], objArr[3]);
            }
    ...
    static final class Array5Func<T1, T2, T3, T4, T5, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        private final Function5<T1, T2, T3, T4, T5, R> f612f;

        Array5Func(Function5<T1, T2, T3, T4, T5, R> function5) {
            this.f612f = function5;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 5) {
                return this.f612f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4]);
            }
    ...
    static final class Array6Func<T1, T2, T3, T4, T5, T6, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function6<T1, T2, T3, T4, T5, T6, R> f613f;

        Array6Func(Function6<T1, T2, T3, T4, T5, T6, R> function6) {
            this.f613f = function6;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 6) {
                return this.f613f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5]);
            }
    ...
    static final class Array7Func<T1, T2, T3, T4, T5, T6, T7, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function7<T1, T2, T3, T4, T5, T6, T7, R> f614f;

        Array7Func(Function7<T1, T2, T3, T4, T5, T6, T7, R> function7) {
            this.f614f = function7;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 7) {
                return this.f614f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6]);
            }
    ...
    static final class Array8Func<T1, T2, T3, T4, T5, T6, T7, T8, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> f615f;

        Array8Func(Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> function8) {
            this.f615f = function8;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 8) {
                return this.f615f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7]);
            }
    ...
    static final class Array9Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> implements Function<Object[], R> {
        ...
        /* renamed from: f  reason: collision with root package name */
        final Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> f616f;

        Array9Func(Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> function9) {
            this.f616f = function9;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 9) {
                return this.f616f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7], objArr[8]);
            }
