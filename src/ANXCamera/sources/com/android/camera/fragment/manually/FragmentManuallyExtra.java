...
public class FragmentManuallyExtra extends BaseFragment {
    ...
    private void initLensRecyclerView(ComponentData componentData) {
        ...
        AnonymousClass4 r3 = new ExtraRecyclerViewAdapter(this.mFragmentManually, componentData2, this.mCurrentMode, this.mManuallyListener, i / i2) {
    ...
    public void showCustomWB(ComponentManuallyWB componentManuallyWB) {
        this.mTargetView = this.mExtraListHorizontal;
        ExtraCustomWBListAdapter extraCustomWBListAdapter = new ExtraCustomWBListAdapter(componentManuallyWB, this.mCurrentMode, this.mManuallyListener);
