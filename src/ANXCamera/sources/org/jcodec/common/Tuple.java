...
public class Tuple {
    ...
    public static <T0, T1, U> List<_2<U, T1>> _2map0(List<_2<T0, T1>> list, Mapper<T0, U> mapper) {
        LinkedList linkedList = new LinkedList();
        for (_2 next : list) {
            linkedList.add(pair(mapper.map(next.v0), next.v1));
        }
        return linkedList;
    }
    ...
    public static <T0, T1, U> List<_2<T0, U>> _2map1(List<_2<T0, T1>> list, Mapper<T1, U> mapper) {
        LinkedList linkedList = new LinkedList();
        for (_2 next : list) {
            linkedList.add(pair(next.v0, mapper.map(next.v1)));
        }
        return linkedList;
    }
    ...
    public static <T0, T1, T2, U> List<_3<U, T1, T2>> _3map0(List<_3<T0, T1, T2>> list, Mapper<T0, U> mapper) {
        LinkedList linkedList = new LinkedList();
        for (_3 next : list) {
            linkedList.add(triple(mapper.map(next.v0), next.v1, next.v2));
        }
        return linkedList;
    }
    ...
    public static <T0, T1, T2, U> List<_3<T0, U, T2>> _3map1(List<_3<T0, T1, T2>> list, Mapper<T1, U> mapper) {
        LinkedList linkedList = new LinkedList();
        for (_3 next : list) {
            linkedList.add(triple(next.v0, mapper.map(next.v1), next.v2));
        }
        return linkedList;
    }
    ...
    public static <T0, T1, T2, U> List<_3<T0, T1, U>> _3map3(List<_3<T0, T1, T2>> list, Mapper<T2, U> mapper) {
        LinkedList linkedList = new LinkedList();
        for (_3 next : list) {
            linkedList.add(triple(next.v0, next.v1, mapper.map(next.v2)));
        }
        return linkedList;
    }
    ...
    public static <T0, T1, T2, T3, U> List<_4<U, T1, T2, T3>> _4map0(List<_4<T0, T1, T2, T3>> list, Mapper<T0, U> mapper) {
        LinkedList linkedList = new LinkedList();
        for (_4 next : list) {
            linkedList.add(quad(mapper.map(next.v0), next.v1, next.v2, next.v3));
        }
        return linkedList;
    }
    ...
    public static <T0, T1, T2, T3, U> List<_4<T0, U, T2, T3>> _4map1(List<_4<T0, T1, T2, T3>> list, Mapper<T1, U> mapper) {
        LinkedList linkedList = new LinkedList();
        for (_4 next : list) {
            linkedList.add(quad(next.v0, mapper.map(next.v1), next.v2, next.v3));
        }
        return linkedList;
    }
    ...
    public static <T0, T1, T2, T3, U> List<_4<T0, T1, U, T3>> _4map3(List<_4<T0, T1, T2, T3>> list, Mapper<T2, U> mapper) {
        LinkedList linkedList = new LinkedList();
        for (_4 next : list) {
            linkedList.add(quad(next.v0, next.v1, mapper.map(next.v2), next.v3));
        }
        return linkedList;
    }
    ...
    public static <T0, T1, T2, T3, U> List<_4<T0, T1, T2, U>> _4map4(List<_4<T0, T1, T2, T3>> list, Mapper<T3, U> mapper) {
        LinkedList linkedList = new LinkedList();
        for (_4 next : list) {
            linkedList.add(quad(next.v0, next.v1, next.v2, mapper.map(next.v3)));
        }
        return linkedList;
    }
    ...
    public static <T0, T1> List<_2<T0, T1>> asList(Map<T0, T1> map) {
        ...
        for (Map.Entry next : map.entrySet()) {
            linkedList.add(pair(next.getKey(), next.getValue()));
        }
        return linkedList;
    }
    ...
    public static <T0, T1> Map<T0, T1> asMap(Iterable<_2<T0, T1>> iterable) {
        HashMap hashMap = new HashMap();
        for (_2 next : iterable) {
            hashMap.put(next.v0, next.v1);
        }
        return hashMap;
    }
