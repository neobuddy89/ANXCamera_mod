...
public abstract class LiveData<T> {
    ...
    private c<Observer<? super T>, LiveData<T>.ObserverWrapper> mObservers = new c<>();
    /* access modifiers changed from: private */
    ...
    public void dispatchingValue(@Nullable LiveData<T>.ObserverWrapper observerWrapper) {
        ...
        do {
            ...
            if (observerWrapper == null) {
                c<K, V>.d ia = this.mObservers.ia();
                while (ia.hasNext()) {
                    considerNotify((ObserverWrapper) ((Map.Entry) ia.next()).getValue());
    ...
    public void postValue(T t) {
        ...
        if (z) {
            android.arch.core.a.c.getInstance().d(this.mPostValueRunnable);
        }
    }
