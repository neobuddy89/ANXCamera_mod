...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    public MenuItem setActionProvider(android.view.ActionProvider actionProvider) {
        this.mWrappedObject.setSupportActionProvider(actionProvider != null ? Build.VERSION.SDK_INT >= 16 ? new ActionProviderWrapperJB(this.mContext, actionProvider) : new ActionProviderWrapper(this.mContext, actionProvider) : null);
        return this;
    }
