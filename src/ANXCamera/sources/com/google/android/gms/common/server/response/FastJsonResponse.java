...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public static Field<byte[], byte[]> forBase64(String str, int i) {
            Field field = new Field(8, false, 8, false, str, i, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
            return field;
        }

        public static Field<Boolean, Boolean> forBoolean(String str, int i) {
            Field field = new Field(6, false, 6, false, str, i, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
            return field;
        }

        public static <T extends FastJsonResponse> Field<T, T> forConcreteType(String str, int i, Class<T> cls) {
            Field field = new Field(11, false, 11, false, str, i, cls, (FieldConverter) null);
            return field;
        }

        public static <T extends FastJsonResponse> Field<ArrayList<T>, ArrayList<T>> forConcreteTypeArray(String str, int i, Class<T> cls) {
            Field field = new Field(11, true, 11, true, str, i, cls, (FieldConverter) null);
            return field;
        }

        public static Field<Double, Double> forDouble(String str, int i) {
            Field field = new Field(4, false, 4, false, str, i, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
            return field;
        }

        public static Field<Float, Float> forFloat(String str, int i) {
            Field field = new Field(3, false, 3, false, str, i, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
            return field;
        }

        public static Field<Integer, Integer> forInteger(String str, int i) {
            Field field = new Field(0, false, 0, false, str, i, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
            return field;
        }

        public static Field<Long, Long> forLong(String str, int i) {
            Field field = new Field(2, false, 2, false, str, i, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
            return field;
        }

        public static Field<String, String> forString(String str, int i) {
            Field field = new Field(7, false, 7, false, str, i, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
            return field;
        }

        public static Field<ArrayList<String>, ArrayList<String>> forStrings(String str, int i) {
            Field field = new Field(7, true, 7, true, str, i, (Class<? extends FastJsonResponse>) null, (FieldConverter) null);
            return field;
        }

        public static Field withConverter(String str, int i, FieldConverter<?, ?> fieldConverter, boolean z) {
            Field field = new Field(fieldConverter.zacj(), z, fieldConverter.zack(), false, str, i, (Class<? extends FastJsonResponse>) null, fieldConverter);
            return field;
        }
