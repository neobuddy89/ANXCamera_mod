...
public interface ModeProtocol {
    ...
    public interface ConfigChanges extends BaseProtocol {
        ...
        void configRGBHistogramSwtich(int i);
        ...
        void reCheckCinematicAspectRatio();
    ...
    public interface MainContentProtocol extends BaseProtocol, EffectCropViewController, IndicatorProtocol, LyingDirectHint {
        ...
        void updateHistogramStats(int[] iArr);

        void updateHistogramStats(int[] iArr, int[] iArr2, int[] iArr3);
        ...
        void updateZoomViewMarginBottom(int i, boolean z);
    }
