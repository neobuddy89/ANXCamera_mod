...
interface zzis {
    ...
    void zza(int i, zzdu zzdu) throws IOException;

    <K, V> void zza(int i, zzgf<K, V> zzgf, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzhd zzhd) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzhd zzhd) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzhd zzhd) throws IOException;

    void zzb(int i, List<zzdu> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzhd zzhd) throws IOException;
