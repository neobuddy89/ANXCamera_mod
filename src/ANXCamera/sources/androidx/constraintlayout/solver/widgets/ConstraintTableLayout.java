...
public class ConstraintTableLayout extends ConstraintWidgetContainer {
    ...
    public String getColumnAlignmentRepresentation(int i) {
        VerticalSlice verticalSlice = this.mVerticalSlices.get(i);
        return verticalSlice.alignment == 1 ? "L" : verticalSlice.alignment == 0 ? Field.CHAR_SIGNATURE_PRIMITIVE : verticalSlice.alignment == 3 ? Field.FLOAT_SIGNATURE_PRIMITIVE : verticalSlice.alignment == 2 ? "R" : "!";
    }
