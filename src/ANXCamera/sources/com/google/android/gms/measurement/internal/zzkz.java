...
public final class zzkz extends AbstractSafeParcelable {
    ...
    zzkz(int i, String str, long j, Long l, Float f2, String str2, String str3, Double d2) {
        this.zzg = i;
        this.zza = str;
        this.zzb = j;
        this.zzc = l;
        ...
        this.zzh = null;
        if (i == 1) {
            this.zzf = f2 != null ? Double.valueOf(f2.doubleValue()) : d3;
        } else {
            this.zzf = d2;
        }
        this.zzd = str2;
    ...
    zzkz(zzlb zzlb) {
        this(zzlb.zzc, zzlb.zzd, zzlb.zze, zzlb.zzb);
    }

    zzkz(String str, long j, Object obj, String str2) {
    ...
    zzkz(String str, long j, String str2) {
        Preconditions.checkNotEmpty(str);
        this.zzg = 2;
        this.zza = str;
        this.zzb = 0;
