...
public class UpdateConstant {
    @UpdateType
    public static final int[] AI_SCENE_CONFIG = {13, 11, 28, 34, 27, 20, 26, 30, 16, 42};
    @UpdateType
    public static final int[] CAMERA_TYPES_INIT = {55, 44, 1, 22};
    @UpdateType
    public static final int[] CAMERA_TYPES_MANUALLY = {6, 16, 15, 63};
    @UpdateType
    public static final int[] CAMERA_TYPES_ON_PREVIEW_SUCCESS = {24, 2, 26, 27, 28, 29, 46, 47, 7, 8, 10, 11, 14, 19, 4, 13, 45, 5, 9, 20, 21, 34, 23, 25, 36, 37, 42, 43, 48, 49, 52, 56, 30, 57, 61, 62, 66, 70};
    @UpdateType
    public static final int[] FUN_TYPES_INIT = {55, 19, 1};
    @UpdateType
    ...
    @UpdateType
    public static final int[] VIDEO_TYPES_INIT = {55, 19, 1};
    @UpdateType
    public static final int[] VIDEO_TYPES_ON_PREVIEW_SUCCESS = {24, 29, 13, 35, 19, 47, 31, 5, 9, 10, 14, 25, 52, 53, 67, 68, 69, 65};
    @UpdateType
