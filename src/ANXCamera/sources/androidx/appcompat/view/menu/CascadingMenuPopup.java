...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private View findParentViewForSubmenu(CascadingMenuInfo cascadingMenuInfo, MenuBuilder menuBuilder) {
        ...
        if (adapter instanceof HeaderViewListAdapter) {
            ...
            menuAdapter = headerViewListAdapter.getWrappedAdapter();
        } else {
            i = 0;
    ...
    private void showMenu(MenuBuilder menuBuilder) {
        ...
        MenuAdapter menuAdapter = new MenuAdapter(menuBuilder2, from, this.mOverflowOnly, ITEM_LAYOUT);
        ...
        if (this.mShowingMenus.size() > 0) {
            ...
            view = findParentViewForSubmenu(cascadingMenuInfo, menuBuilder2);
        } else {
        ...
        this.mShowingMenus.add(new CascadingMenuInfo(createPopupWindow, menuBuilder2, this.mLastPosition));
