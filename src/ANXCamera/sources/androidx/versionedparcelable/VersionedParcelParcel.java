...
class VersionedParcelParcel extends C0173VersionedParcel {
    ...
    public C0173VersionedParcel createSubParcel() {
        ...
        int i2 = i;
        VersionedParcelParcel versionedParcelParcel = new VersionedParcelParcel(parcel, dataPosition, i2, this.mPrefix + "  ", this.mReadCache, this.mWriteCache, this.mParcelizerCache);
