...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, Fragment fragment, int i2, DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog zaa = GoogleApiAvailability.zaa((Context) activity, i, DialogRedirect.getInstance(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i, SupportedConfigFactory.CLOSE_BY_BURST_SHOOT), i2), onCancelListener);
        if (zaa == null) {
            return false;
        }
